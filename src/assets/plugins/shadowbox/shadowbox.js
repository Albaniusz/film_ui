...
(function(){
    ...
    var options = {
         ...
         * - qt: Film file extensions supported by QuickTime
         * - wmp: Film file extensions supported by Windows Media Player
         * - qtwmp: Film file extensions supported by both QuickTime and Windows Media Player
    ...
    Shadowbox.setup = function(links, opts){
        ...
        }else if(typeof links.length != 'number'){ //not perfect, but better!
